...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__BrowserRouter__ = __webpack_require__(668);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__HashRouter__ = __webpack_require__(669);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__NavLink__ = __webpack_require__(671);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__Redirect__ = __webpack_require__(673);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__StaticRouter__ = __webpack_require__(674);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__Switch__ = __webpack_require__(675);
/* harmony reexport (binding) */ __webpack_require__.d(exports, "Switch", function() { return __WEBPACK_IMPORTED_MODULE_10__Switch__["a"]; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__matchPath__ = __webpack_require__(676);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__withRouter__ = __webpack_require__(677);
...
var _setAuthToken = __webpack_require__(120);

var _setAuthToken2 = _interopRequireDefault(_setAuthToken);

var _setLocalStorage = __webpack_require__(462);
...
var baseKeys = __webpack_require__(535),
    getTag = __webpack_require__(539),
    isArguments = __webpack_require__(546),
    isArray = __webpack_require__(547),
    isArrayLike = __webpack_require__(548),
    isBuffer = __webpack_require__(549),
    isPrototype = __webpack_require__(158),
    isTypedArray = __webpack_require__(550);
...
var _helper = __webpack_require__(367);
...
/* harmony export (binding) */ __webpack_require__.d(exports, "b", function() { return createPath; });
...
exports.shipmentActions = exports.shipmentTypes = exports.messengerState = exports.labelState = exports.correctShipmentExists = exports.getShipmentForRole = exports.messengerAllowed = exports.messengerAvailable = exports.waitingForPostmatesUpdate = exports.imageLoader = exports.fireShipmentCreate = undefined;
...
var waitingForPostmatesUpdate = exports.waitingForPostmatesUpdate = function waitingForPostmatesUpdate(orders) {
  var ordersNeedUpdates = orders.filter(function (order) {
    if (order.shipments.length > 0) {
      var lastShipment = order.shipments[order.shipments.length - 1];
      var messengerShipment = lastShipment.delivery_type === "messenger_shipment";
      var delivered = lastShipment.status === "delivered";
...
var Symbol = __webpack_require__(156),
    getRawTag = __webpack_require__(538),
...
var _FormSelect = __webpack_require__(47);
...
var _alterationsLists = __webpack_require__(459);
...
var _OrderCard = __webpack_require__(368);

var _OrderCard2 = _interopRequireDefault(_OrderCard);

var _OrderCardIcon = __webpack_require__(369);
...
var _LogoMessage = __webpack_require__(77);
...
var _OrderComplete = __webpack_require__(80);
...
var TermsOfService = function TermsOfService(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        "li",
        { style: { fontFamily: "sans-serif", weight: 400, fontSize: "16px", lineHeight: "18px" } },
        _react2.default.createElement(
          "span",
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_3_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__matchPath__ = __webpack_require__(113);
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; };
...
var stylesInDom = {},
	...
	fixUrls = __webpack_require__(711);
...
var _NavigationBar = __webpack_require__(383);
...
var _growler = __webpack_require__(381);
...
var _reactIntercom = __webpack_require__(122);
...
var _newOrdersReducer = __webpack_require__(441);
...
var _searchResultsReducer = __webpack_require__(442);
...
var FooterItem = function FooterItem(props) {
  console.log('poopie doopie loopie');
  return _react2.default.createElement(
    'li',
...
var _FooterItem = __webpack_require__(364);

var _FooterItem2 = _interopRequireDefault(_FooterItem);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var renderFooterItemList = function renderFooterItemList(list) {
  return list.map(function (item, i) {
    console.log('hji"');
    var text = item.text,
        link = item.link;

    return _react2.default.createElement(_FooterItem2.default, {
      key: i,
      text: text,
      link: link });
  });
...
var FooterItems = function FooterItems() {
  var list = [{ text: 'Terms of Service', link: '/terms_of_service' }];
...
var _FooterItems = __webpack_require__(365);
...
var Footer = function Footer(props) {
  return _react2.default.createElement(
    'div',
    { className: 'footer' },
    _react2.default.createElement(_FooterItems2.default, null)
  );
};
...
var _WelcomeKitPrint = __webpack_require__(401);

var _WelcomeKitPrint2 = _interopRequireDefault(_WelcomeKitPrint);

var _SelectTailor = __webpack_require__(79);
...
var _newOrderLists = __webpack_require__(460);

var _NewOrderDetail = __webpack_require__(372);

var _NewOrderDetail2 = _interopRequireDefault(_NewOrderDetail);

var _NewOrderCustomerDetail = __webpack_require__(371);
...
var _WithSectionHeader = __webpack_require__(35);
...
var _NavigationLinks = __webpack_require__(385);
...
var _hamburger = __webpack_require__(719);
...
var _NavigationLink = __webpack_require__(384);
...
var _SelectGarment = __webpack_require__(392);
...
var _SelectAlterations = __webpack_require__(391);
...
var _Checkout = __webpack_require__(388);

var _Checkout2 = _interopRequireDefault(_Checkout);

var _orderDetails = __webpack_require__(396);

var _orderDetails2 = _interopRequireDefault(_orderDetails);

var _AgreeToTerms = __webpack_require__(413);
...
var _HowToPinModal = __webpack_require__(393);
...
var _reactModal = __webpack_require__(123);
...
var _FindCustomerByPhone = __webpack_require__(395);
...
var _CustomerInfo = __webpack_require__(394);
...
var _supplies = __webpack_require__(720);
...
var _Measurements = __webpack_require__(400);
...
var _InputMeasurement = __webpack_require__(399);
...
var _helper = __webpack_require__(406);
...
var _OrderReportRows = __webpack_require__(403);
...
var _EditPassword = __webpack_require__(141);
...
var _TermsOfService = __webpack_require__(139);
...
var AgreeToTerms = function (_Component) {
  ...
  function AgreeToTerms() {
    ...
    return _possibleConstructorReturn(this, (AgreeToTerms.__proto__ || Object.getPrototypeOf(AgreeToTerms)).apply(this, arguments));
  }
  ...
  _createClass(AgreeToTerms, [{
    ...
    value: function render() {
      return _react2.default.createElement(
        'div',
        { style: { width: "90%", margin: "50px auto", height: "500px", textAlign: "center" } },
        _react2.default.createElement(
          'div',
        ...
        _react2.default.createElement('input', {
          ...
          onClick: function onClick() {
            return console.log('agreed to terms');
          } })
      );
    }
  }]);
...
exports.default = (0, _WithSectionHeader2.default)(AgreeToTerms);
...
var _SelectStore = __webpack_require__(415);
...
var _nodeFetch = __webpack_require__(121);
...
var _reducerHelpers = __webpack_require__(461);
...
var _CompaniesNew = __webpack_require__(374);
...
var _orders = __webpack_require__(407);

var _orders2 = _interopRequireDefault(_orders);

var _reports = __webpack_require__(402);
...
var _TailorIndex = __webpack_require__(379);
...
var _index3 = __webpack_require__(375);

var _index4 = _interopRequireDefault(_index3);

var _ReportRoutes = __webpack_require__(448);

var _ReportRoutes2 = _interopRequireDefault(_ReportRoutes);

var _CompanyRoutes = __webpack_require__(447);
...
var _CustomerEdit = __webpack_require__(380);
...
var _ArchivedOrders = __webpack_require__(78);

var _ArchivedOrders2 = _interopRequireDefault(_ArchivedOrders);

var _NewOrders = __webpack_require__(373);
...
var _OrdersShow = __webpack_require__(398);

var _OrdersShow2 = _interopRequireDefault(_OrdersShow);

var _OrdersEdit = __webpack_require__(386);
...
var _OrdersNew = __webpack_require__(390);
...
var _OrderConfirmation = __webpack_require__(389);

var _OrderConfirmation2 = _interopRequireDefault(_OrderConfirmation);

var _AdminOrderRoutes = __webpack_require__(452);

var _AdminOrderRoutes2 = _interopRequireDefault(_AdminOrderRoutes);

var _StoreOrdersRoutes = __webpack_require__(453);
...
var _TermsOfServicePage = __webpack_require__(414);

var _TermsOfServicePage2 = _interopRequireDefault(_TermsOfServicePage);
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(_reactRouterDom.Route, {
            ...
            render: function render() {
              return _react2.default.createElement(_TermsOfServicePage2.default, null);
            }
          }),
          _react2.default.createElement(_reactRouterDom.Route, {
            exact: true,
...
var _edit = __webpack_require__(412);

var _edit2 = _interopRequireDefault(_edit);

var _StoresNew = __webpack_require__(409);
...
var _UsersNew = __webpack_require__(416);

var _UsersNew2 = _interopRequireDefault(_UsersNew);

var _edit = __webpack_require__(419);
...
var _SiteRoutes = __webpack_require__(455);

var _SiteRoutes2 = _interopRequireDefault(_SiteRoutes);

var _AuthRoutes = __webpack_require__(450);

var _AuthRoutes2 = _interopRequireDefault(_AuthRoutes);

var _OrderRoutes = __webpack_require__(454);

var _OrderRoutes2 = _interopRequireDefault(_OrderRoutes);

var _AdminRoutes = __webpack_require__(449);

var _AdminRoutes2 = _interopRequireDefault(_AdminRoutes);

var _StoreRoutes = __webpack_require__(456);
...
var _UserRoutes = __webpack_require__(457);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__createBrowserHistory__ = __webpack_require__(493);
/* unused harmony reexport createBrowserHistory */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__createHashHistory__ = __webpack_require__(494);
...
var DataView = __webpack_require__(527),
    ...
    Set = __webpack_require__(530),
    WeakMap = __webpack_require__(531),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createHashHistory__ = __webpack_require__(491);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_MemoryRouter__ = __webpack_require__(678);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Prompt__ = __webpack_require__(679);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Redirect__ = __webpack_require__(680);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_Switch__ = __webpack_require__(682);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_matchPath__ = __webpack_require__(113);
// Written in this round about way for babel-transform-imports
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_react_router_es_withRouter__ = __webpack_require__(683);
// Written in this round about way for babel-transform-imports
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_prop_types___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_2_prop_types__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_history_createMemoryHistory__ = __webpack_require__(492);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4_history__ = __webpack_require__(496);
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
//# sourceMappingURL=bundle.0ca4e0a37edcc112528b.js.map