...
var Login = function (_Component) {
  ...
  _createClass(Login, [{
    ...
    value: function getUsersStore() {
      ...
      _axios2.default.get('/api/store/' + store_id, (_Axios$get = {}, _defineProperty(_Axios$get, access - token, accessToken), _defineProperty(_Axios$get, 'client', client), _defineProperty(_Axios$get, 'uid', uid), _Axios$get)).then(function (res) {
        console.log(res);
      }).catch(function (err) {
        console.log(err);
      });
